function __base-test_complete_repeating_option -a expected_commands expected_options
    complete -c 'base-test' -n "__base-test_should_offer_completions_for_flags_or_option_values '$expected_commands' '$expected_options'" $argv[3..-3] -fa "$expected_options"
    complete -c 'base-test' -n "__base-test_should_offer_completions_for_flags_or_option_values '$expected_commands' '$expected_options' 'contains -- \"\$option\" (string split -n \\' \\' -- \$expected_options)'" $argv[-2..]
end
...
__base-test_complete_non_repeating_option 'base-test' '--one' 
__base-test_complete_non_repeating_option 'base-test' '--two' 
__base-test_complete_non_repeating_option 'base-test' '--custom-three' 
__base-test_complete_repeating_option 'base-test' '--kind-counter' 
...
__base-test_complete_non_repeating_option 'base-test' '-h --help' -d 'Show help information.'
...
__base-test_complete_non_repeating_option 'base-test sub-command' '-h --help' -d 'Show help information.'
...
__base-test_complete_non_repeating_option 'base-test escaped-command' '-h --help' -d 'Show help information.'