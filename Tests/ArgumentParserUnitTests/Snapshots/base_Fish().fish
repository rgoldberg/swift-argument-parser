function __base-test_complete_flag -a expected_commands expected_flags description
...
function __base-test_complete_option -a expected_commands expected_options
    __base-test_complete_flag $argv
...
function __base-test_should_offer_completions_for_positional -a expected_commands expected_positional_index
...
function __base-test_parse_tokens -S
    ...
    case 'base-test'
        ...
        case 'escaped-command'
            __base-test_parse_subcommand 1 false 'o:n[e=' 'h/help' || return
        case 'help'
            __base-test_parse_subcommand 1 true  || return
        end
    end
end
...
function __base-test_tokens
    ...
    eval "function __base-test_tokens
        commandline \$argv | read $tokenize -la tokens
        printf %s\n \$tokens
    end"

    __base-test_tokens $argv
end

function __base-test_parse_subcommand -Sa expected_positional_count expected_is_repeating
...
__base-test_complete_option 'base-test' '--name' 'The user\'s name.' -fka ''
__base-test_complete_option 'base-test' '--kind' '' -fka 'one two custom-three'
__base-test_complete_option 'base-test' '--other-kind' '' -fka 'b1_fish b2_fish b3_fish'
__base-test_complete_option 'base-test' '--path1' '' -F
__base-test_complete_option 'base-test' '--path2' '' -F
__base-test_complete_option 'base-test' '--path3' '' -fka 'c1_fish c2_fish c3_fish'
__base-test_complete_flag 'base-test' '--one' ''
__base-test_complete_flag 'base-test' '--two' ''
__base-test_complete_flag 'base-test' '--custom-three' ''
__base-test_complete_flag 'base-test' '--kind-counter' ''
__base-test_complete_option 'base-test' '--rep1' '' -fka ''
__base-test_complete_option 'base-test' '-r --rep2' '' -fka ''
...
__base-test_complete_flag 'base-test' '-h --help' 'Show help information.'
...
__base-test_complete_flag 'base-test sub-command' '-h --help' 'Show help information.'
__base-test_complete_option 'base-test escaped-command' '--o:n[e' 'Escaped chars: \'[]\\.' -fka ''
...
__base-test_complete_flag 'base-test escaped-command' '-h --help' 'Show help information.'