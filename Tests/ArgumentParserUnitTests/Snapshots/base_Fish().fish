...
function __base-test_should_offer_completions_for_positional -a expected_commands positional_index_comparison expected_positional_index
...
complete -c 'base-test' -n '__base-test_should_offer_completions_for_flags_or_options "base-test" one' -l 'one' -d 'ROSSGOLDBERG' -rfka ''
complete -c 'base-test' -n '__base-test_should_offer_completions_for_flags_or_options "base-test" two' -l 'two' -d 'ROSSGOLDBERG' -rfka ''
complete -c 'base-test' -n '__base-test_should_offer_completions_for_flags_or_options "base-test" three' -l 'three' -d 'ROSSGOLDBERG' -rfka ''
